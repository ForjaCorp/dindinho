...
- **Exemplo:** [Princípios](../../00-geral/principios.md).
...
- **Exemplo:** [Guia de Relatórios](../../40-plataformas/pwa/relatorios.md).
...
- **Exemplo:** [Evolução de Rotas](../em-discussao/evolucao-rotas.md).
